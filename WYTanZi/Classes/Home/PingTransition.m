...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    WYHomeViewController * fromVC = (WYHomeViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
...
//    CGRect convertFrame = button.frame; 原始的
    ...
    UIBezierPath *maskStartBP =  [UIBezierPath bezierPathWithOvalInRect:convertFrame];
